      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Por que assinar o <span className="text-[#cf0707]">PETVIP</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Benefício 1 */}
          <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-all border border-[#e8d9c5]">
            <div className="w-14 h-14 bg-[#f5eee6] rounded-xl flex items-center justify-center mb-6 text-[#063c8f]">
          ...
          {/* Benefício 2 */}
          <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-all border border-[#e8d9c5]">
            <div className="w-14 h-14 bg-[#f5eee6] rounded-xl flex items-center justify-center mb-6 text-[#cf0707]">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
