...
const HeroSection = () => {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-orange-50 to-beige-100 z-0"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          {/* Conteúdo de texto */}
          <div className="text-center md:text-left">
            <span className="inline-block bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4 animate-pulse">
              EXCLUSIVO PARA PET LOVERS!
            </span>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6">
              Todo mês uma <span className="text-orange-600">surpresa</span> para seu pet!
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-8 rounded-full transition-all transform hover:scale-105 shadow-lg">
                Quero Assinar Agora!
              </button>
              <button className="border-2 border-orange-600 text-orange-600 hover:bg-orange-50 font-semibold py-3 px-8 rounded-full transition-all">
                Conheça os Planos
              </button>
            </div>
          ...
          <div className="relative">
            <div className="relative w-full h-80 md:h-96 lg:h-[500px]">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-orange-200 rounded-full w-32 h-32 z-0 opacity-30"></div>
              <div className="absolute -top-6 -left-6 bg-beige-300 rounded-full w-24 h-24 z-0 opacity-30"></div>
            </div>
