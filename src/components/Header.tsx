...
const HeroSection = () => {
  ...
  // Efeito para lidar com o scroll quando a página carrega
  useEffect(() => {
          ...
          <div className="text-center md:text-left order-2 md:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button 
                ...
                className="bg-[#cf0707] hover:bg-[#b30606] text-white font-bold py-3 px-8 rounded-full transition-all transform hover:scale-105 shadow-lg"
              >
                Quero Assinar Agora!
              </button>
