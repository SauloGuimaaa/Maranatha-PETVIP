...
const PricingSection = () => {
  return (
    <section className="py-16 md:py-24 bg-orange-50" id="planos">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Escolha o melhor para seu <span className="text-orange-600">pet</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Plano Básico */}
          <div className="bg-white p-8 rounded-2xl shadow-sm border-2 border-orange-100 hover:shadow-md transition-all transform hover:-translate-y-1">
            <div className="mb-6">
            ...
            <button className="w-full bg-orange-100 hover:bg-orange-200 text-orange-700 font-bold py-3 px-6 rounded-full transition-all">
              Assinar Plano Essencial
            </button>
          </div>

          {/* Plano Premium (Destaque) */}
          <div className="relative bg-white p-8 rounded-2xl shadow-md border-2 border-orange-300 hover:shadow-lg transition-all transform hover:-translate-y-1">
            ...
            <div className="mb-6">
              ...
              <span className="text-gray-500">/mês</span>
              <span className="block text-sm text-orange-600 mt-1">Economize 15%</span>
            </div>
            ...
            <button className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-6 rounded-full transition-all transform hover:scale-105">
        ...
        {/* Garantia */}
        <div className="mt-16 text-center bg-white p-6 rounded-xl shadow-sm max-w-3xl mx-auto border border-orange-100">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            ...
            <div>
              <p className="text-gray-800 font-medium">
                <span className="font-bold text-orange-600">Garantia PETVIP:</span> Se seu pet não amar os produtos, devolvemos seu dinheiro em até 7 dias!
              </p>
            </div>
          </div>
        </div>
